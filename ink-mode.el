;; ink-mode.el --- Major mode for editing inklestudio's ink files.

;; Copyright (C) 2017 Lukas Ahrenberg
;;
...
;; Notes: Only regexp-based highlighting (and syntax table) right now, meaning
;; that it currently can not capture any context.
